...
En primer lugar habría que descargar los datos de publicaciones de
[WoS](http://www.webofknowledge.com)) en formato texto, 
para lo que se pueden seguir los pasos descritos
[aquí](https://rubenfcasal.github.io/scimetr/articles/docs/WoS_export.html).
...
- Descarga de datos empleando la [API de WoS](https://developer.clarivate.com/apis)
  (al estilo del paquete [wosr](https://vt-arc.github.io/wosr/index.html))
